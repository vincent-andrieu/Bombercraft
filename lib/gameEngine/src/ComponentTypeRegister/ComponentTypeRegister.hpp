...
template <typename T>
ComponentTypeRegister<T>::ComponentTypeRegister(std::vector<Signature> &entityToBitset)
: _entitySignatures(entityToBitset)
{
}

template <typename T>
void ComponentTypeRegister<T>::allocate(std::size_t size)
{
...
template <typename T>
T &ComponentTypeRegister<T>::get(Entity entity)
{
...
template <typename T>
template <typename... Args>
void ComponentTypeRegister<T>::add(Entity entity, Args &&...args)
{
...
template <typename T>
void ComponentTypeRegister<T>::remove(Entity entity)
{
...
template <typename T>
bool ComponentTypeRegister<T>::tryRemove(Entity entity)
{
...
template <typename T>
Entity ComponentTypeRegister<T>::getOwner(const T &component)
{
